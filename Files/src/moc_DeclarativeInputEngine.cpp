...
void DeclarativeInputEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DeclarativeInputEngine *_t = static_cast<DeclarativeInputEngine *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DeclarativeInputEngine::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeInputEngine::keyboardRectangleChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (DeclarativeInputEngine::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeInputEngine::animatingChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (DeclarativeInputEngine::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeclarativeInputEngine::inputModeChanged)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject DeclarativeInputEngine::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DeclarativeInputEngine.data,
      qt_meta_data_DeclarativeInputEngine,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DeclarativeInputEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DeclarativeInputEngine.stringdata0))
        return static_cast<void*>(const_cast< DeclarativeInputEngine*>(this));
