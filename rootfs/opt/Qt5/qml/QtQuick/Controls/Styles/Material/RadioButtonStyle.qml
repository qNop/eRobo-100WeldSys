...
RadioButtonStyle {
    ...
    indicator: Rectangle {
        implicitWidth: 38//Units.dp(48)
        implicitHeight: 38//Units.dp(48)
        ...
        Rectangle {
            ...
            implicitWidth: 16//Units.dp(20)
            implicitHeight: 16//Units.dp(20)
            radius: implicitHeight / 2
            color: "transparent"
            ...
            Rectangle {
                ...
                implicitWidth: control.checked ? 8 : 0// Units.dp(10) : 0
                implicitHeight: control.checked ? 8 : 0// Units.dp(10) : 0
