...
function openDatabase() {
    ...
    db.transaction( function(tx) {
                tx.executeSql('CREATE TABLE IF NOT EXISTS FlatWeldSingleBevelGrooveT(mode TEXT,fouction TEXT,\
               ...
               table = tx.executeSql("select * from FlatWeldSingleBevelGrooveT");
                ...
                tx.executeSql('CREATE TABLE IF NOT EXISTS FlatWeldSingleBevelGroove(mode TEXT,fouction TEXT,\
                                                setvalue TEXT,max TEXT,min TEXT,step TEXT,init TEXT,decription TEXT)');
               table = tx.executeSql("select * from FlatWeldSingleBevelGroove");
                ...
                tx.executeSql('CREATE TABLE IF NOT EXISTS FlatWeldVGroove(mode TEXT,fouction TEXT,\
                                                setvalue TEXT,max TEXT,min TEXT,step TEXT,init TEXT,decription TEXT)');
               table = tx.executeSql("select * from FlatWeldVGroove");
                ...
                tx.executeSql('CREATE TABLE IF NOT EXISTS FlatFillet(mode TEXT,fouction TEXT,\
                                                setvalue TEXT,max TEXT,min TEXT,step TEXT,init TEXT,decription TEXT)');
               table = tx.executeSql("select * from FlatFillet");
                ...
                tx.executeSql('CREATE TABLE IF NOT EXISTS HorizontalWeldSingleBevelGrooveT(mode TEXT,fouction TEXT,\
                                                setvalue TEXT,max TEXT,min TEXT,step TEXT,init TEXT,decription TEXT)');
               table = tx.executeSql("select * from HorizontalWeldSingleBevelGrooveT");
                ...
                tx.executeSql('CREATE TABLE IF NOT EXISTS HorizontalWeldSingleBevelGroove(mode TEXT,fouction TEXT,\
                                                setvalue TEXT,max TEXT,min TEXT,step TEXT,init TEXT,decription TEXT)');
               table = tx.executeSql("select * from HorizontalWeldSingleBevelGroove");
                ...
                tx.executeSql('CREATE TABLE IF NOT EXISTS VerticalWeldSingleBevelGrooveT(mode TEXT,fouction TEXT,\
                                                setvalue TEXT,max TEXT,min TEXT,step TEXT,init TEXT,decription TEXT)');
               table = tx.executeSql("select * from VerticalWeldSingleBevelGrooveT");
                ...
                tx.executeSql('CREATE TABLE IF NOT EXISTS VerticalWeldSingleBevelGroove(mode TEXT,fouction TEXT,\
                                                setvalue TEXT,max TEXT,min TEXT,step TEXT,init TEXT,decription TEXT)');
               table = tx.executeSql("select * from VerticalWeldSingleBevelGroove");
                ...
                tx.executeSql('CREATE TABLE IF NOT EXISTS VerticalWeldVGroove(mode TEXT,fouction TEXT,\
                                                setvalue TEXT,max TEXT,min TEXT,step TEXT,init TEXT,decription TEXT)');
